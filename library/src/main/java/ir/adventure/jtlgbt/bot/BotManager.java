...
import ir.adventure.jtlgbt.bot.callback.GetFileCallback;
import ir.adventure.jtlgbt.bot.handlers.ByteArrayHandler;
import ir.adventure.jtlgbt.bot.handlers.StringHandler;
import ir.adventure.jtlgbt.bot.interceptor.Interceptor;
import ir.adventure.jtlgbt.bot.user.BotUserEntityInterface;
import ir.adventure.jtlgbt.bot.user.BotUserServiceInterface;
import ir.adventure.jtlgbt.bot.user.DefaultBotUserService;
import ir.adventure.jtlgbt.exception.BadRequestException;
import ir.adventure.jtlgbt.utils.Session;
...
public class BotManager {
    ...
    public BotManager addInterceptor(Interceptor interceptor) {
